...
import { Eye, EyeOff, AlertCircle, CheckCircle, Unlock } from 'lucide-react';
        ...
        <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl">
          <CardHeader className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h2 className="text-2xl font-semibold text-gray-100">Business Unlocked!</h2>
            </div>
            <p className="text-gray-400">Welcome to Music Business Unlocked</p>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <Alert className="rounded-xl border-red-500/50 bg-red-500/10">
              <AlertCircle className="h-4 w-4 text-red-400" />
              <AlertDescription className="text-red-400">
                Please check your email to verify your account before accessing all features.
              </AlertDescription>
            </Alert>
            <p className="text-sm text-gray-400">
              You can now start calculating your streaming royalties and unlock insights into your music business.
            </p>
          </CardContent>
        </div>
      </div>
      ...
      <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl shadow-2xl">
        <CardHeader className="text-center pb-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-semibold text-gray-100">Join Today</h2>
            <p className="text-gray-400 font-medium">Unlock your music business potential</p>
          </div>
        </CardHeader>
